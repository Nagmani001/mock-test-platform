...
export const SectionWritingBadge = ({ number }: { number: number }) => {
  return (
...
export const SectionWritingFailBadge = ({ number }: { number: number }) => {
  return (
    <div className="w-[48px] h-[56px] flex items-center justify-center">
      <svg viewBox="0 0 38 47" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <defs>
...
export const SectionWritingMarkedBadge = ({ number }: { number: number }) => {
  return (
    <div className="w-[48px] h-[56px] flex items-center justify-center">
      <svg viewBox="0 0 38 47" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <defs>
...
export const SectionWritingNotVisitedBadge = ({ number }: { number: number }) => {
  return (
    <div className="w-[48px] h-[56px] flex items-center justify-center">
      <svg viewBox="0 0 38 47" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        <defs>
...
export const SectionWritingAnsweredMarkedBadge = ({ number }: { number: number }) => {
  return (
