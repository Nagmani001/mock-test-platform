      ...
      <form className="max-w-lg mx-auto">
        <div className="flex">
          ...
          <div className="relative w-full">
            ...
            <button type="submit" className="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-[#980884] rounded-e-lg border border-[#980884] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
